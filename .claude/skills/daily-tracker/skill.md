...
- User mentions an unknown person/place/exercise → invoke journal agent QUERY (see `shared.md`), use context brief in response, write back to cache — this is always-on regardless of mode
